...
<div id="wrap"> 
  ...
  <!--sub menu--> 
	...
	<form action="CummulativeController" method="post">
	<fieldset>
	<legend>BUS Booking</legend>
	<input type="date" name="bdate" placeholder="Date Of Journey *" required="required">
	<input type="time" name="btime" placeholder="Time *" required="required">
	<textarea name="bpol" placeholder="PickUp Location" cols="40" rows="5" required="required"></textarea>
	<textarea name="bdol" placeholder="Drop-off Location" cols="40" rows="5" required="required"></textarea>
	<h3>Type of service!</h3>
	<p><input type="radio" name="btype" value="AMTS">
	AMTS
	</p>
	<p><input type="radio" name="btype" value="BRTS">
	BRTS
	</p>            
