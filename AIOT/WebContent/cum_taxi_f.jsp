...
<div id="wrap"> 
  ...
  <!--sub menu--> 
	...
	<form action="Cum_tax_cont" method="post">
	<fieldset>
	<legend>Taxi Booking</legend>
	<input type="date" name="tadate" placeholder="Date Of Journey *" required="required">
	<input type="time" name="tatime" placeholder="Time *" required="required">
	<textarea name="tapol" placeholder="PickUp Location" cols="40" rows="5" required="required"></textarea>
	<textarea name="tadol" placeholder="Drop-off Location" cols="40" rows="5" required="required"></textarea>
	<h3>Type of Cab!</h3>
	<p><input type="radio" name="tatype" value="cab">
	Cab(3-4 persons)
	</p>
	<p><input type="radio" name="tatype" value="SUV">
	SUV(6-7 persons)
	</p>            
	<p><input type="radio" name="tatype" value="Sedan">    
	Sedan (2-3 persons)
	</p>
	</fieldset>
