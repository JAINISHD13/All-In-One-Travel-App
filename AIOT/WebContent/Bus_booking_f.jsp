...
<body>
  ...
  <!-- HEADER END -->
	...
	<textarea name="pol" placeholder="PickUp Location" cols="40" rows="5" required="required"></textarea>
	<textarea name="dol" placeholder="Drop-off Location" cols="40" rows="5" required="required"></textarea>
	<h3>Type of service!</h3>
	<p><input type="radio" name="type" value="AMTS">
	AMTS
	</p>
	<p><input type="radio" name="type" value="BRTS">
	BRTS
	</p>            
	
	</fieldset>

	<input type="submit" value="BOOK A BUS NOW!" />
	<div class="reset">
