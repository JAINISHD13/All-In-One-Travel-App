...
<tr><td><b>pickup location:</b><pre>   <%=ploc %></pre></td><td><b>dropoff location:</b><pre>   <%=dloc %></pre></td></tr>
<tr><td><b>service type:</b><pre>   <%=tos %></pre></td><td><b>number of kms and duration(in minutes):</b><pre>   <%=kms %>kms   <%=min %>mins</pre></td></tr>
</table>
<br><br>
<table border="1px" width=100%>
	
	<tr><td><b>FARE:</b></td><td><%=fare %></td></tr>
	<tr><td><b>TAX:4%</b></td><td><%=Math.round(fare *0.04)%></td></tr>
	<tr><td><b>Cost of Time spent in taxi</b></td><td><%=Math.round((min*1.02)) %></td></tr>
	<tr><td><b>CAB/AUTO rate are to be paid on the spot</b></td>
	<tr><td><b>GROSS</b></td><td><%=total %></td>
	</table>
